...
export GITOPS_REPO_URL=https://github.com/rhtap-qe-jsmid/qm5jduh5x-java-quarkus-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-nxjkn.nxjkn.sandbox1479.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-nxjkn.nxjkn.sandbox1479.opentlc.com}
